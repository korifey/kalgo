...
// final result.
//
// Note: In Java solutions, you must name the main class "MainSumAll". Otherwise,
// you will get a compilation error.

class sum_all {
    public static int GetN() { return 100;}
    public static long GetNumber(long pos) { return pos;}
}

public class MainSumAll {
